...
def save_checkpoint(state, filename='train_result.pth.tar'):
    """
    Saves the result of training which may be used to resume training later.
    """
    torch.save(state, os.path.join(G.output_dir, filename))
